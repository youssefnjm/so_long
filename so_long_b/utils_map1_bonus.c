...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025-01-15 12:50:49 by ynoujoum          #+#    #+#             */
/*   Updated: 2025-01-15 12:50:49 by ynoujoum         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_map(char **map, t_info *info)
{
	...
	if (check_characters(map, info) == 1)
		return (1);
	if (info->exit != 1 || info->coin == 0
		|| info->person != 1 || info->enemy > 1)
		return (1);
